...
const SECTION_ORDER: SectionDef[] = [
  {
    ...
    items: [
      { type: 'link', label: 'Abstract', href: '/whitepaper/00-abstract' },
      { type: 'link', label: '1. The Vision', href: '/whitepaper/01-1-the-vision' },
      { type: 'link', label: 'How the Protocol Works Today', href: '/whitepaper/02-how-the-protocol-works-today-high-level-implementation-aware' },
      { type: 'link', label: 'Why Credibility Matters', href: '/whitepaper/03-why-credibility-matters-and-why-over-collateralization-shouldnt-be-the-only-answer' },
      { type: 'link', label: '2. Design Goals and Non-Goals', href: '/whitepaper/02-2-design-goals-and-non-goals' },
      { type: 'link', label: '3. System Overview', href: '/whitepaper/03-3-system-overview' },
      { type: 'link', label: '4. Cryptographic Primitives & Proof Integration', href: '/whitepaper/04-4-cryptographic-primitives-proof-integration' },
      { type: 'link', label: '5. Trade Protocol (On- and Off-Ramp)', href: '/whitepaper/05-5-trade-protocol-on-and-off-ramp' },
      { type: 'link', label: '6. Proof-of-Credibility', href: '/whitepaper/06-6-proof-of-credibility-reputation-matching' },
      { type: 'link', label: '7. Fraud Prevention', href: '/whitepaper/07-7-fraud-prevention' },
      { type: 'link', label: '8. Dispute Resolution', href: '/whitepaper/08-8-dispute-resolution' },
      { type: 'link', label: '9. Pricing & Oracle Mechanics', href: '/whitepaper/09-9-pricing-oracle-mechanics' },
      { type: 'link', label: '10. Liquidity & Market Design', href: '/whitepaper/10-10-liquidity-market-design' },
      { type: 'link', label: '11. Security Model', href: '/whitepaper/11-11-security-model' },
      { type: 'link', label: '12. Privacy Model', href: '/whitepaper/12-12-privacy-model' },
      { type: 'link', label: '13. Compliance & Policy Positioning', href: '/whitepaper/13-13-compliance-policy-positioning' },
      { type: 'link', label: '14. Accessing P2P Protocol: Clients & SDKs', href: '/whitepaper/14-14-accessing-p2p-protocol-clients-sdks' },
      { type: 'link', label: '15. Governance & Upgradability', href: '/whitepaper/15-15-governance-upgradability' },
      { type: 'link', label: '16. Token Economics', href: '/whitepaper/16-16-token-economics' },
      { type: 'link', label: '17. Disclosures & Risks', href: '/whitepaper/17-17-disclosures-risks' },
      { type: 'link', label: '18. References', href: '/whitepaper/18-18-references' },
      { type: 'link', label: 'Appendices', href: '/whitepaper/21-appendices' },
    ],
  },
  {
    key: 'for-investors',
